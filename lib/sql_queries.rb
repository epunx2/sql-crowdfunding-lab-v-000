...
"SELECT category, SUM(pledges.amount) AS pledge_amount FROM projects INNER JOIN pledges ON pledges.project_id = projects.id WHERE category = 'music' GROUP BY category"
end
